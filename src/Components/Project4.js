    ...
    return (
        <div className = "projects-container">
            <div className = "projects-box">
                <img src={require("../../src/Sources/project4.png")} alt="KEC Presence" className = "projects-image"></img>
                <div>
                    <p className = "projects-header"><b>STUDENT ATTENDANCE MANAGEMENT SYSTEM</b></p>
                    <p className = "projects-content">Student Attendance Management System is a Java application designed to track and manage student attendance efficiently.</p>
